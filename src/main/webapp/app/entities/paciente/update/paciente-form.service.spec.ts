      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            nroHistoria: expect.any(Object),
            nombreRepresentante: expect.any(Object),
            parentescoRepresentante: expect.any(Object),
            correoRepresentante: expect.any(Object),
            celularRepresentante: expect.any(Object),
            direccionRepresentante: expect.any(Object),
