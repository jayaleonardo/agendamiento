...
import { sampleWithRequiredData } from '../especialista.test-samples';
...
describe('Especialista Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to especialistaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEspecialistaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEspecialistaIdentifier).toHaveBeenCalledWith(entity);
