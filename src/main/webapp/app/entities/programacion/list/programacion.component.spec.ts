...
import { sampleWithRequiredData } from '../programacion.test-samples';
...
describe('Programacion Management Component', () => {
  let comp: ProgramacionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProgramacionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.programacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to programacionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProgramacionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProgramacionIdentifier).toHaveBeenCalledWith(entity);
