...
import { sampleWithRequiredData } from '../contacto.test-samples';
...
describe('Contacto Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to contactoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getContactoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getContactoIdentifier).toHaveBeenCalledWith(entity);
